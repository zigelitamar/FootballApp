...
public class PlayersDAL implements DAL<Member,String>{
    ...
    @Override
    public boolean insert(Member member) throws SQLException, NoConnectionException, UserInformationException {
        Member check=null;
        try {
    ...
    @Override
    public Member find(String userName) throws SQLException, UserInformationException, UserIsNotThisKindOfMemberException, NoConnectionException {
        ...
        PersonalInfo page = new PersonalPagesDAL().find(personlPID);
